	...
	<div class="container mt-5">
		...
		<div class="nav">
			<div class="btn-group btn-group-toggle user">
			 <a class="btn btn-primary tambah" role="button" href="tambah.php" data-toggle="modal" data-target="#modaltambah">Tambah Data</a>
			 <a href="hapus.php" class="btn btn-primary hapus" role="button">Hapus Data</a>
			</div>

			<form class="form-inline ml-auto" action="" method="post" id="search">
